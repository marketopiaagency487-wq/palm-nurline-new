...
const AGENT_EMAIL = "apkzoz85@gmail.com";
const AGENT_ADDRESS = "القاهرة الجديدة، القاهرة، جمهورية مصر العربية"; // ← عدّلها للعنوان بالشارع والمبنى
...
const FAQS = [
  ...
  { q: "من هو الوكيل المعتمد؟", a: "هذا الموقع تديره شركة جراندير سبيسز (Grandeur Spaces)، وكيل مبيعات معتمد لدى بالم هيلز للتطوير العقاري. لسنا الشركة المطوّرة. نقدم استشارة عقارية مجانية ونساعدك في اختيار الوحدة وإتمام الحجز، والتعاقد والسداد يتمّان مع المطوّر مباشرة وبعقوده المعتمدة." },
];
